...
module.exports = () => {
  ...
  const definedEnvs = helpers.mapEnvsToPrimitiveTypes();
  definedEnvs['process.env.all'] = JSON.stringify(definedEnvs);

  return {
    name: 'wepback-single-build-template',
    bail: true,
    ...
    plugins: [
      new webpack.DefinePlugin(definedEnvs),
